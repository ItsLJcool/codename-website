...
Clone your fork, run the update script, then build the ***completely untouched*** engine and launch it. If it runs fine, you know your tools work. ***After that***, make a branch and start editing.
